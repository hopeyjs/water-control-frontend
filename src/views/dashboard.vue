        ...
        <div class="card card-statistics">
          <div class="card-body">
            <div class="d-flex justify-content-between flex-wrap">
              ...
              <div>
                <p class="card-text text-right">Average Daily Usage</p>
        ...
        <div class="card card-statistics">
          <div class="card-body">
            <div class="d-flex justify-content-between flex-wrap">
              ...
              <div>
                <p class="card-text text-right">Average Monthly Usage</p>
                <div class="fluid-container">
      ...
      <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
        <div class="card card-statistics">
          <div class="card-body">
            <div class="d-flex justify-content-between flex-wrap">
              <div>
                <i class="mdi mdi-poll-box text-teal icon-md"></i>
              </div>
              <div>
                <p class="card-text text-right">Unit Balance</p>
                <div class="fluid-container">
        ...
        <div class="card card-statistics">
          <div class="card-body">
            <div class="d-flex justify-content-between flex-wrap">
              ...
              <div>
                <p class="card-text text-right">Water Flow Status</p>
                <div class="fluid-container">
